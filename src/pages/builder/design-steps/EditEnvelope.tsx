...
const ENVELOPE_STYLES = [
  ...
  { id: "lace", name: "Dentelle", icon: "👑", description: "Motifs détaillés" },
  {
    ...
    name: "Kraft",
    icon: "📦",
    description: "Naturel et rustique",
  },
  {
    id: "vellum",
    name: "Vélin",
...
export function EditEnvelope({ ctx }: { ctx: any }) {
  ...
  const getFilteredFonts = () => {
    ...
    const category =
      FONT_CATEGORIES[selectedFontCategory as keyof typeof FONT_CATEGORIES];
      ...
      <div className="lg:col-span-2">
        <Card className="border-0 shadow-lg bg-gradient-to-br from-white to-gray-50/50">
          ...
          <CardContent className="p-6">
            <div
              className="rounded-2xl border-2 border-dashed border bg-gradient-to-br from-gray-50 to-white p-8"
              style={envelopePreviewStyle}
            >
              {/* Zone d'adresse destinataire */}
              <div className="absolute top-8 left-8 w-56 p-4 bg-white/90 backdrop-blur-sm rounded-lg border border shadow-sm">
                <div
                  style={{
                    fontFamily,
              ...
              {showStamp && (
                <div
                  className="absolute top-8 right-8 w-16 h-20 rounded-lg flex items-center justify-center text-white text-xs font-bold shadow-lg"
              ...
              {showWaxSeal && (
                <div
                  className="absolute bottom-8 right-8 w-14 h-14 rounded-full flex items-center justify-center text-white text-xl font-bold shadow-xl"
            ...
            >
              <div className="border-b bg-gradient-to-r from-gray-50 to-white">
                <TabsList className="grid grid-cols-3 w-full bg-transparent p-0 h-12">
                  <TabsTrigger
                    value="elements"
                    className="rounded-none data-[state=active]:border-b-2 data-[state=active]:border-purple-500 data-[state=active]:bg-purple-50 data-[state=active]:text-purple-700"
                  >
              ...
              >
                ...
                <div className="space-y-3 pt-4 border-t">
                  ...
                  <div className="flex gap-2">
                    <Button
                      variant={showWaxSeal ? "default" : "outline"}
                      size="sm"
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {WAX_SEAL_COLORS.map((c) => (
                        <button
                          key={c.id}
                          onClick={() => setWaxSealColor(c.color)}
                          className={`w-8 h-8 rounded-full border-2 ${
                            waxSealColor === c.color
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <Badge variant="secondary" className="text-xs">
                      {ENVELOPE_TEMPLATES.length} modèles
                    </Badge>
                  </div>
                    ...
                    <div className="grid grid-cols-1 gap-3 pr-2">
                      {ENVELOPE_TEMPLATES.map((template) => (
                        <div
                          ...
                          className="group cursor-pointer rounded-xl border-2 border hover:border-purple-400 transition-all duration-300 overflow-hidden"
                        >
                          <div
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-3 pt-4 border-t">
                      ...
                      <Select
                        ...
                        onValueChange={setSelectedFontCategory}
                      >
                    ...
                    <div className="space-y-3">
                      <Label className="text-sm font-medium">
                        Police ({getFilteredFonts().length})
                      </Label>
                    ...
                    <div className="space-y-3">
                      <Label className="text-sm font-medium">
                        Espacement lettres: {letterSpacing}px
                      </Label>
                      <input
                        type="range"
                        min="-5"
                    ...
                    <div className="space-y-3">
                      ...
                      <Select value={textShadow} onValueChange={setTextShadow}>
                        ...
                        <SelectContent>
                          ...
                          <SelectItem value="1px 1px 2px rgba(0,0,0,0.3)">
                            Légère
                          </SelectItem>
                          <SelectItem value="2px 2px 4px rgba(0,0,0,0.4)">
                            Moyenne
                          </SelectItem>
                          <SelectItem value="3px 3px 6px rgba(0,0,0,0.5)">
                            Forte
                          </SelectItem>
                          <SelectItem value="0 0 10px #ff00ff, 0 0 20px #ff00ff">
                            Néon Rose
                          </SelectItem>
                          <SelectItem value="0 0 10px #00ffff, 0 0 20px #00ffff">
                            Néon Cyan
                          </SelectItem>
                          <SelectItem value="0 0 10px #ffd700, 0 0 20px #ffd700">
                            Néon Or
                          </SelectItem>
                        </SelectContent>
                      </Select>
